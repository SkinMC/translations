...
return [
    ...
    */
    ...
    'wallpapers' => [
        'title' => 'الخلفية',
        'challenge' => [
            'title' => 'تحدي خلفية الشاشة',
            'description' => 'حدد الفائز لشهر :challenge_month. سيتم عرض الخلفية المختارة على الصفحة الرئيسية في :display_month.',
            'back_to_moderation' => 'العودة إلى الإشراف',
            'month_label' => 'شهر التحدي',
            'previous_month' => 'الشهر الماضي',
            'next_month' => 'الشهر التالي',
            'shortlisted' => ':count في القائمة المختصرة',
            'winner_selected' => 'الفائز المختار',
            'no_winner_selected' => 'لم يتم اختيار فائز',

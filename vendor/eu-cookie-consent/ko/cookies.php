...
return [
    'acceptAllButton' => '모두 동의',
    'save' => '저장',
    'PopupTitle' => '쿠키 동의',
    'PopupDescription' => 'SkinMC는 기능을 제공하기 위해 쿠키를 사용해요.',

    'customise' => '사용자 지정',
    'customise_title' => '쿠키 사용자 지정',

    'essential' => '필수 데이터',
    'essential_description' => '필수 데이터 쿠키는 사이트를 방문할 때 필수적으로 사용되는 쿠키예요. 비활성화할 수 없어요.',

    'session' => '세션 쿠키: PHP는 쿠키를 사용자 세션을 구별하기 위해 사용해요.',
    'xsrf-token' => 'XSRF-Token 쿠키: 애플리케이션에서 관리하는 각 활성 사용자 세션에 자동으로 CSRF "토큰"을 생성해요. 이 토큰은 인증된 사용자가 애플리케이션에 실제로 요청을 하는 사용자인지 확인할 때 사용해요.',

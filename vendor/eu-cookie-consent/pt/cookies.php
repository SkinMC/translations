...
return [
    ...
    'functional_description' => 'Estes cookies permitem o fornecimento de funcionalidades melhoradas como vídeos. Eles podem ser configurados por nós ou por provedores terceiros, cujos serviços adicionamos às nossas páginas. Se você não permitir estes cookies, alguns ou todas essas funcionalidades podem não funcionar corretamente.',
    'youtube' => 'YouTube',

    'analytical' => 'Cookies analíticos',
    'analytical_description' => 'Esses cookies nos permitem contar visitas e fontes de tráfego para podermos medir e melhorar o desempenho de nosso site. Se você não permitir esses cookies, informações desses cookies não serão usadas para ajudar a performance do site.',

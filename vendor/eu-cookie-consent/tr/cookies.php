...
return [
    ...
    'customise_title' => 'Özel çerezler',

    'essential' => 'Temel veriler',
    'essential_description' => 'Temel veri çerezleri, ziyaret ettiğiniz siteyi teknik olarak çalıştırmak için gereklidir. Onları devre dışı bırakamazsınız.',

    'session' => 'Oturum Tanımlama Bilgisi: PHP, kullanıcı oturumlarını tanımlamak için bir Tanımlama Bilgisi kullanır.',
    ...
    'analytical_description' => 'Bu çerezler, sitemizin performansını ölçebilmemiz ve iyileştirebilmemiz için ziyaretleri ve trafik kaynaklarını saymamıza olanak tanır. Bu tanımlama bilgilerine izin vermezseniz, bu tanımlama bilgilerinin bilgileri site performansına yardımcı olmak için kullanılmayacaktır.',
